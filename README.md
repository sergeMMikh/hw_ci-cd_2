# Домашнее задание к занятию 9 «Процессы CI/CD» - Сергей Михалёв
...
1. Результат запуска команды `mvn package`</br>
   <img src="images/Task_3.png" alt="Task_3.png" width="700" height="auto">
2. Ссылка на [*pom.xml*](mvn/pom.xml)
